...
export const servicesDetailedData: ServiceDetailedItem[] = [
  {
    ...
    imageAlt: "High-retention short-form video production",
    badge: "VIRAL CORE",
    counter: "01 / 04",
  },
  {
    ...
    imageAlt: "Social management and audience growth campaign",
    badge: "GROWTH ENGINE",
    counter: "02 / 04",
  },
  {
    ...
    imageAlt: "Creative direction and visual branding assets",
  ...
  },
  {
    ...
    imageAlt: "Full multi-platform presence and campaign execution",
